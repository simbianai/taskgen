...
class HelpfulAssistant(Agent):
    def __init__(self):
        ...
        super().__init__(
            ...
            memory_bank={'Function': Memory(memory=[], top_k=5, mapper=<function Agent.__init__.<locals>.<lambda> at 0x111c58720>, approach='retrieve_by_ranker', ranker=<taskgen.ranker.Ranker object at 0x110d44110>),},
            shared_variables={},
